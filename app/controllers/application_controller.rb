class ApplicationController < ActionController::Base
  ...
  private
    ...
    def remote_url
      ...
      request_path = '/ru/na-povestke-dnya/reestr-postavschikov-sotsialnyh-uslug' if request_path.match(/\A\/ru\/na-povestke-dnya\/reestr-postavschikov-sotsialnyh-uslug.*/) # routes for my register providers
