...
module Family
  class Application < Rails::Application
    ...
    config.active_record.observers = :request_observer, :social_provider_observer
    ...
    # Rack::UTF8Sanitizer is a Rack middleware which cleans up invalid UTF8 characters
